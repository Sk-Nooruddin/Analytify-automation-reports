...
```
Error: locator.click: Error: strict mode violation: getByPlaceholder('Section HEADER') resolved to 3 elements:
    1) <textarea rows="1" col="50" id="step1" type="text" name="header" cdktextareaautosize="" data-id="1_s_stephead" _ngcontent-ng-c3340435993="" placeholder="Section HEADER" class="cdk-textarea-autosize form-control bs4-textarea stepSectionStyle bordernone customrSpace ng-pristine ng-valid ng-star-inserted ng-touched hideResize pad-size pad-section"></textarea> aka locator('#step1')
    2) <textarea rows="1" col="50" id="step2" type="text" name="header" cdktextareaautosize="" data-id="1_s_stephead" _ngcontent-ng-c3340435993="" placeholder="Section HEADER" class="cdk-textarea-autosize form-control bs4-textarea stepSectionStyle bordernone customrSpace ng-pristine ng-valid ng-star-inserted ng-touched hideResize pad-size pad-section"></textarea> aka locator('#step2')
    3) <textarea rows="1" col="50" id="step3" type="text" name="header" cdktextareaautosize="" data-id="1_s_stephead" _ngcontent-ng-c3340435993="" placeholder="Sub Section HEADER" class="cdk-textarea-autosize form-control bs4-textarea stepSectionStyle bordernone customrSpace ng-pristine ng-valid ng-star-inserted ng-touched hideResize pad-size pad-section"></textarea> aka getByRole('textbox', { name: 'Sub Section HEADER' })

Call log:
  - waiting for getByPlaceholder('Section HEADER')
...
> 58  |   await page.getByPlaceholder('Section HEADER').click();
      |                                                 ^ Error: locator.click: Error: strict mode violation: getByPlaceholder('Section HEADER') resolved to 3 elements:
  59  | 
