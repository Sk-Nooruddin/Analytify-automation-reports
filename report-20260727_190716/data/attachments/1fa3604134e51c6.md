...
Call log:
  - waiting for locator('tbody tr').nth(1).locator('td').nth(3)
    - locator resolved to <td dnddropzone="" id="tdIdrowcol24" _ngcontent-ng-c1800375335="" class="notSelectedField ng-star-inserted">…</td>
  ...
  2 × retrying click action
      ...
      - scrolling into view if needed
      - done scrolling
      - <td _ngcontent-ng-c3868374522="">Column2</td> from <div tabindex="-1" role="dialog" id="tablePropertie" aria-hidden="false" data-keyboard="false" data-backdrop="static" class="modal fade show" _ngcontent-ng-c3868374522="">…</div> subtree intercepts pointer events
...
```ts
  ...
  212 | const cell = page.locator('tbody tr').nth(1).locator('td').nth(3);
  213 | 
> 214 | await cell.click();
      |            ^ TimeoutError: locator.click: Timeout 30000ms exceeded.
  215 | 
  216 | console.log(await cell.textContent());
  217 | 
  218 | await page.getByText('Select an option', { exact: true }).nth(0).click();
  219 | await page.locator('.dg-select-option:text-is("TextArea")').click();
  220 | 
  221 | await page.getByRole('button', { name: 'Ok' }).click();
  222 | 
