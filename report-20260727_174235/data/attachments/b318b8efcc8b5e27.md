...
```
Error: locator.click: Error: strict mode violation: getByText('Text', { exact: true }) resolved to 3 elements:
    1) <span draggable="true" data-group="basic" data-key="textarea" data-type="textarea" dndeffectallowed="move" _ngcontent-ng-c680531232="" id="cbp_editor_TextDataEntry" class="d-flex btn btn-primary btn-sm btn-block formcomponent drag-copy ng-star-inserted">…</span> aka locator('#mySidenav').getByText('Text', { exact: true })
    2) <span draggable="true" data-group="basic" data-key="textarea" data-type="textarea" dndeffectallowed="move" _ngcontent-ng-c680531232="" id="cbp_editor_TextDataEntry" class="d-flex btn btn-primary btn-sm btn-block formcomponent drag-copy ng-star-inserted">…</span> aka getByText('Text').nth(2)
    3) <div _ngcontent-ng-c1246892924="" class="dg-select-option ng-star-inserted">…</div> aka locator('#tablePropertie').getByText('Text', { exact: true })

Call log:
  - waiting for getByText('Text', { exact: true })
...
> 206 | await page.getByText('Text', { exact: true }).click();
      |                                               ^ Error: locator.click: Error: strict mode violation: getByText('Text', { exact: true }) resolved to 3 elements:
  207 | await page.getByRole('button', { name: 'Ok' }).click();
  208 | 
