...
Locator: getByText('Welcome to 10.0 Development')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Welcome to 10.0 Development')

```

```yaml
- navigation:
  - text: Welcome to Dataglance Enterprise Data Management Solutions
  - list:
    - listitem:
      - list:
        - listitem:
          - button:
            - img
- text:  ⚠ CRITICAL ALERT CX2026
- button "✕"
- heading "Application" [level=2]
- paragraph: Core enterprise modules
- img "eWork"
- text: eWork Work order management & field tracking
- img "CBP Editor"
- text: CBP Editor Content blueprint & process editor
- img "eDocument"
- text: eDocument Document repository & version control
- img "eMedia"
- text: eMedia Media library & asset center
- img "eAsset"
- text: eAsset Asset lifecycle & inventory tracking
- img "ePlan"
- text: ePlan Planning, scheduling & resource allocation
- img "eEngineer"
- text: eEngineer Engineering design & execution
- heading "Application Setup & Management" [level=2]
- paragraph: Configuration, administration & system tools
- img "Application Setup"
- text: Application Setup System configuration & preferences
- img "User Management"
- text: User Management Roles, permissions & access control
- img "Device Management"
- text: Device Management Connected device registry & control
- img "Administration"
- text: Administration System administration & control panel
- img "System Setup"
- text: System Setup Core infrastructure & environment
- img "Documentation"
- text: Documentation Guides, references & API docs
- contentinfo: Copyright DataGlance, Inc. 2021-2026. All rights are reserved. See product license for details.
```
