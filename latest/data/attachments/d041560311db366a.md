...
Call log:
  - waiting for locator('tbody tr').nth(1)
    - locator resolved to <tr id="row2" cdkdrag="" cdkdraglockaxis="y" _ngcontent-ng-c1800375335="" cdkdragpreviewcontainer="parent" class="cdk-drag ng-star-inserted">…</tr>
  - attempting click action
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <input min="1" max="100" required="" step="0.01" type="number" name="columnsize" _ngcontent-ng-c3868374522="" class="form-control ng-untouched ng-pristine ng-valid"/> from <div tabindex="-1" role="dialog" id="tablePropertie" aria-hidden="false" data-keyboard="false" data-backdrop="static" class="modal fade show" _ngcontent-ng-c3868374522="">…</div> subtree intercepts pointer events
  - retrying click action
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <div _ngcontent-ng-c3868374522="" class="modal-body p-2 pad-top">…</div> from <div tabindex="-1" role="dialog" id="tablePropertie" aria-hidden="false" data-keyboard="false" data-backdrop="static" class="modal fade show" _ngcontent-ng-c3868374522="">…</div> subtree intercepts pointer events
  - retrying click action
    - waiting 20ms
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <label _ngcontent-ng-c3868374522="">Column Size(%)</label> from <div tabindex="-1" role="dialog" id="tablePropertie" aria-hidden="false" data-keyboard="false" data-backdrop="static" class="modal fade show" _ngcontent-ng-c3868374522="">…</div> subtree intercepts pointer events
  2 × retrying click action
      ...
      - scrolling into view if needed
      - done scrolling
      - <td class="text-center" _ngcontent-ng-c3868374522="">25 </td> from <div tabindex="-1" role="dialog" id="tablePropertie" aria-hidden="false" data-keyboard="false" data-backdrop="static" class="modal fade show" _ngcontent-ng-c3868374522="">…</div> subtree intercepts pointer events
  ...
  4 × retrying click action
    ...
    - retrying click action
      ...
      - scrolling into view if needed
      - done scrolling
      - <div class="row" _ngcontent-ng-c3868374522="">…</div> from <div tabindex="-1" role="dialog" id="tablePropertie" aria-hidden="false" data-keyboard="false" data-backdrop="static" class="modal fade show" _ngcontent-ng-c3868374522="">…</div> subtree intercepts pointer events
    - retrying click action
      - waiting 500ms
      - waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <th class="text-center wid-19" _ngcontent-ng-c3868374522="">Column Size(%)</th> from <div tabindex="-1" role="dialog" id="tablePropertie" aria-hidden="false" data-keyboard="false" data-backdrop="static" class="modal fade show" _ngcontent-ng-c3868374522="">…</div> subtree intercepts pointer events
    - retrying click action
      - waiting 500ms
      - waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
          ...
          - generic [ref=e911]:
            ...
            - generic [ref=e920]:
              ...
              - generic [ref=e956]:
                ...
                - generic [ref=e968]:
                  - generic [ref=e971]:
                    - generic [ref=e972]: Position
                    - textbox [ref=e973]: "2"
                  - generic [ref=e975]:
                    - generic [ref=e976]:
                      - generic [ref=e977]: Title
                      - textbox [ref=e978]: Column2
                    - generic [ref=e979]:
                      - generic [ref=e980]: Column Size(%)
                      - spinbutton [ref=e981]: "25"
                  - generic [ref=e984]:
                    - generic [ref=e985]: Data Type
                    - generic [ref=e988] [cursor=pointer]:
                      - generic [ref=e989]: Select an option
                      - img [ref=e991]
                  - generic [ref=e995]:
                    - generic [ref=e996]: Field Name
                    - textbox [ref=e997]: Column2
        - generic [ref=e998]:
          - button "Reset" [ref=e999] [cursor=pointer]
          - button "Ok" [ref=e1000] [cursor=pointer]
          - button "Cancel" [ref=e1001] [cursor=pointer]
```
...
> 213 | await page.locator('tbody tr').nth(1).click();
      |                                       ^ TimeoutError: locator.click: Timeout 30000ms exceeded.
  214 | // Wait until the property panel updates
  215 | await expect(page.locator('input').first()).toHaveValue('2'); // or Position field
  216 | await page.getByText('Select an option', { exact: true }).nth(0).click();
  217 | await page.locator('.dg-select-option:text-is("TextArea")').click();
  218 | 
  219 | await page.getByRole('button', { name: 'Ok' }).click();
  220 | 
