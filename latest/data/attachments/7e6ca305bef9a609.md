...
> 213 | await page.getByText('Select an option', { exact: true }).nth(0).click();
      |                                                                  ^ TimeoutError: locator.click: Timeout 30000ms exceeded.
  214 | await page.locator('.dg-select-option:text-is("TextArea")').click();
  215 | 
  216 | await page.getByRole('button', { name: 'Ok' }).click();
  217 | 
