...
Call log:
  - waiting for getByText('Select an option', { exact: true }).nth(1)
...
```ts
  ...
  211 | 
  212 | await page.locator('tr.cdk-drag.e-point.ng-star-inserted').locator('td').nth(3).click();
  213 | console.log(await page.locator('tr.cdk-drag.e-point.ng-star-inserted').locator('td').nth(3).count());
> 214 | await page.getByText('Select an option', { exact: true }).nth(1).click();
      |                                                                  ^ TimeoutError: locator.click: Timeout 30000ms exceeded.
