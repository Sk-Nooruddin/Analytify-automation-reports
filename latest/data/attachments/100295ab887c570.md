...
```
Error: locator.click: Error: strict mode violation: locator('.dg-select-trigger') resolved to 2 elements:
    1) <div aria-expanded="false" class="dg-select-trigger" _ngcontent-ng-c1246892924="">…</div> aka locator('.dg-select-trigger').first()
    2) <div aria-expanded="false" class="dg-select-trigger" _ngcontent-ng-c1246892924="">…</div> aka locator('.ng-untouched > .dg-select-container > .dg-select-trigger')

Call log:
  - waiting for locator('.dg-select-trigger')
...
> 213 | page.getByText('Column2', { exact: true }).nth(0).click();
      |                                                   ^ Error: locator.click: Test ended.
  214 | await page.locator('.dg-select-trigger').click();
  215 | 
  216 | // Select TextArea
